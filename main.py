...
credenciales_table.field_names = [
    "Tipo de Usuario",
    "Nombre de Usuario",
    "Contraseña",
]
credenciales_table.add_row(
    ["Admin", credenciales_admin["usuario"], credenciales_admin["contrasena"]]
)
credenciales_table.add_row(
    [
        "Usuario Común",
        credenciales_usuario_comun["usuario"],
        credenciales_usuario_comun["contrasena"],
    ]
)
print("Credenciales de Prueba:")
print(credenciales_table)
print(
    "Se requiere que ingrese algunas de las credenciales indicadas para ejecutar el código"
)

# Solicitar al usuario que ingrese su tipo de cliente
tipo_usuario = input(
    "Por favor, ingrese su tipo de cliente (admin/usuario): "
).lower()
